...
export default function SectionTres() {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
        <div className="w-full bg-white py-12 px-8 text-center flex flex-col items-center">
          <h1 className="text-5xl font-extrabold leading-tight mb-6 text-black">
            Say goodbye to{" "}
            <span className="relative inline-block">
              <span className="bg-[#c9d1fc] px-3 py-1 rounded-lg">
          ...
          <p className="text-gray-600 text-xl">
                    ...
                    have all the tools you need to manage your finances with ease.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mt-12">
                ...
                <div className="bg-white p-8 rounded-lg shadow-lg flex flex-col items-center justify-center">
                    <h2 className="text-2xl font-semibold mb-6 text-black">Quick and easy</h2>
                    <p className="text-gray-600 text-center mb-8">
                        Your journey is seamless, safe, and secure. No need to register or
                        download apps.
                    </p>
                ...
                <div className="bg-white p-8 rounded-lg shadow-lg flex flex-col justify-between">
                    <div>
                        ...
                        <div className="bg-gray-50 p-6 rounded shadow-sm flex justify-between items-center mb-6">
                            ...
                            <input
                                type="text"
                                placeholder="5,000"
                                className="text-right outline-none font-bold text-lg"
                            />
                        </div>
                    ...
                    <button className="bg-[#6f5bf7] text-white py-3 px-6 rounded w-full text-lg font-bold">
                        CONTINUE
                    </button>
